...
TARGET real_t cloud_to_rain(real_t t, real_t qc, real_t qr, real_t nc) {
  constexpr real_t qmin_ac = real_t{1.00e-06}; // threshold for auto conversion
  constexpr real_t tau_max = real_t{0.90e+00}; // maximum allowed value of tau
  constexpr real_t tau_min = real_t{1.00e-30}; // maximum allowed value of tau
  constexpr real_t a_phi =
      real_t{6.00e+02}; // constant in phi-function for autoconversion
  constexpr real_t b_phi =
      real_t{0.68e+00}; // exponent in phi-function for autoconversion
  constexpr real_t c_phi =
      real_t{5.00e-05}; // exponent in phi-function for accretion
  constexpr real_t ac_kernel =
      real_t{5.25e+00}; // kernel coeff for SB2001 accretion
  constexpr real_t x3 =
      real_t{2.00e+00}; // gamma exponent for cloud distribution
  constexpr real_t x2 =
      real_t{2.60e-10}; // separating mass between cloud and rain
  constexpr real_t x1 =
      real_t{9.44e+09}; // kernel coeff for SB2001 autoconversion
