...
TEST_F(MuphysTest, TransitionTestSuite_RainToGraupel_1) {
  ...
  real_t dvsw = 0.0;
  real_t dt = 30;
  real_t reference_float = 5.1570357e-17;
  real_t reference_double = 5.1570340525841922e-17;
...
TEST_F(MuphysTest, TransitionTestSuite_RainToGraupel_2) {
  ...
  real_t dvsw = 0.0;
  real_t dt = 30;
  real_t reference = 1.0044914238516472e-12;
...
TEST_F(MuphysTest, TransitionTestSuite_RainToGraupel_3) {
  ...
  real_t dvsw = 0.0;
  real_t dt = 30;
  real_t reference = 5.1423851647153399e-17;
...
TEST_F(MuphysTest, TransitionTestSuite_VaporXIce_default) {
  ...
  real_t result = transition::vapor_x_ice(qi, mi, eta, dvsi, rho, dt);
  validate(result, ZERO);
}
...
TEST_F(MuphysTest, TransitionTestSuite_VaporXIce) {
  ...
  real_t dt = 30;
  real_t rho = 1.19691;
  real_t reference_float = 2.210617e-09;
  real_t reference_double = 2.2106162342610385e-09;
